<template>
  <main class="testimonial-grid">
    <article class="testimonial grid-cols-span-2 flow bg-primary-400 quote text-neutral-100">
      <div class="flex">
        <div>
    ...
    <article class="testimonial grid-cols-span-2  flow bg-secondary-500 text-neutral-100">
      <div class="flex">
        <div>
